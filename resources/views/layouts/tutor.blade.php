...
<body id="page-top">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
        <div class="sidebar-brand-icon">
          <img id="logo" src="{{ asset('img/logoUtp.png')}}" width="150" alt="">
        </div>
        <!-- <div class="sidebar-brand-text mx-3">Tutorias</div> -->
      </a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{ url('tutorias/grupoxalumno/')}}">
          <i class="fas fa-fw fa-cog"></i>
          <span>Tutorado</span></a>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="#">Cedula grupal</a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">{{auth()->user()->maestro->nombre}}</span>
  ...
  <!-- Angular -->
  <script src="{{ asset('angular/modules/angular.min.js') }}"></script>
